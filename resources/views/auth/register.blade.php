...
<div class="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-6 shadow-sm">
    <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">{{ __('messages.register') }}</h1>
    ...
    <p class="mt-4 text-center text-sm text-gray-600 dark:text-gray-400">
        {{ __('messages.already_have_account') }} <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:text-indigo-500 dark:text-indigo-400">{{ __('messages.login') }}</a>
    </p>
</div>
@endsection
